          ...
          <div className="pt-3 grid grid-cols-1 gap-2">
            ...
            {websiteHref && (
              <button
                type="button"
                onMouseDown={() => logClick("click_website")}
                onClick={() => go(websiteHref, hookup(true))}
...
function EnquiryModal(props: {
  ...
  function logClickModal(event: "click_message" | "click_website" | "click_phone") {
    if (areaId) {
      recordEventBeacon({ cleanerId: cleaner.id, areaId, event, sessionId });
    } else if (
      typeof searchLat === "number" &&
      Number.isFinite(searchLat) &&
      typeof searchLng === "number" &&
      ...
      recordEventBeacon({ cleanerId: cleaner.id, areaId: null, event, sessionId });
    }
  }

  const inputClass =
    "h-11 rounded-xl border border-black/10 px-3 outline-none focus:ring-2 focus:ring-[#1D4ED8]/35 bg-white";
      ...
      <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-6">
        <div className="relative w-full max-w-md bg-white rounded-2xl shadow-xl ring-1 ring-black/10 overflow-hidden max-h-[calc(100vh-2rem)]">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="text-sm text-night-700 mt-1">
                  Send an enquiry and they’ll get back to you.
                </p>
              </div>
              <button
                type="button"
          ...
          >
            ...
            {/* Optional address (keeps your Google Places UX) */}
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="min-h-[120px] rounded-xl border border-black/10 px-3 py-2 outline-none focus:ring-2 focus:ring-[#1D4ED8]/35 bg-white"
                placeholder="Tell them what you need, bin types, frequency, access notes…"
                required
              />
            </div>
          ...
          <div className="px-5 py-4 border-t border-black/5 bg-white">
            <div className="flex flex-col gap-2">
              ...
              >
                {submitting === "email" ? "Sending…" : "Send Enquiry"}
              </button>
            </div>
...
// tiny helper to keep TS happy in that one call
function hookup<T>(v: T) {
  return v;
}
