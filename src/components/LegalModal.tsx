...
function TermsContent({ brandName }: { brandName: string }) {
  return (
    <article className="prose max-w-none prose-gray">
      ...
      <p>
        Businesses registering on the platform confirm that:
      </p>
      <ul>
...
function PrivacyContent({ brandName }: { brandName: string }) {
  return (
    <article className="prose max-w-none prose-gray">
      ...
      <ul>
        <li>
          <strong>Legitimate interests</strong> – operating and improving a
          business directory
        </li>
        <li>
      ...
      <p>
        We share personal data only where necessary to operate the website,
        including with:
      </p>
      <ul>
      ...
      <p>
        When you submit an enquiry, your details are sent directly to the
        selected business.
      </p>
      <p>
        Once sent, that business becomes independently responsible for how it
        processes your personal data. We encourage you to review their privacy
        practices.
      </p>
      ...
      <p>
        ...
        functionality, maintain login sessions, load maps, and analyse usage
        where permitted.
      </p>
      <p>
      ...
      <p>
        ...
        described in this policy or to meet legal and regulatory requirements.
      </p>
      ...
      <p>
        ...
        personal data, including secure hosting, encryption, and access
        controls.
      </p>
      ...
      <p>
        ...
        rights, please contact us using the details provided on the website.
      </p>
    </article>
  );
}
  ...
  return (
    <article className="prose max-w-none prose-gray">
      ...
      <p>
        ...
        website. They help the site function properly, remember preferences, and
        (where enabled) understand how the site is used.
      </p>
      <p>
      ...
      <p>
        We use cookies and similar technologies (such as local storage) for:
      </p>
      <ul>
        ...
        <li>
          Analytics (only where enabled and where you have provided consent, if
          required)
        </li>
      </ul>
      ...
      <p>
        These cookies are required for the website to work and cannot be switched
        off in our systems. They are usually set in response to actions you take,
        such as logging in or submitting forms.
      </p>
      <ul>
      ...
      <p>
        These help us remember choices you make (for example, basic preferences)
      ...
      <p>
        These cookies help us understand how visitors use the website so we can
        improve performance and user experience. We will only use these where
        enabled and where consent is required.
      </p>
      <ul>
      ...
      <p>
        Some features on {brandName} rely on third-party services. For example,
        map and place search features may load content from providers such as
        Google. These providers may set cookies or use similar technologies.
      </p>
      <p>
        We do not control third-party cookies. Their use is governed by the
        third party’s own policies.
      </p>

      <h2>4. Local storage</h2>
      <p>
        In addition to cookies, we may use local storage in your browser to store
        certain preferences and session-related values to improve usability and
        maintain stability (for example, remembering UI state).
      </p>

      <h2>5. Managing cookies</h2>
      <p>
        You can control and delete cookies through your browser settings. You can
        usually:
      </p>
      <ul>
      ...
      <p>
        If you block strictly necessary cookies, parts of the website may not
        work (for example, business login and account pages).
      </p>
      ...
      <h2>7. Contact</h2>
      <p>
        If you have questions about cookies or privacy on {brandName}, please
  ...
  return (
    <article className="prose max-w-none prose-gray">
      ...
      <p>
        ...
        allow businesses to increase their visibility within search results,
        service categories, or defined geographic areas.
      </p>
      <p>
        Sponsored Listings are clearly identified as sponsored or featured and
        are separate from organic (non-paid) search results.
      </p>

      <h2>2. Advertising only – no endorsement</h2>
      <p>
        Payment for a Sponsored Listing does <strong>not</strong> constitute an
        endorsement, recommendation, or verification of the business, its
        services, or its suitability for any purpose.
      </p>
      <p>
        {brandName} does not assess the quality of services provided by sponsored
        businesses. Users are responsible for carrying out their own checks
        before engaging any listed business.
      </p>

      <h2>3. How sponsored placement works</h2>
      <p>
        Sponsored Listings may appear in prominent positions, including but not
        limited to:
      </p>
      <ul>
      ...
      <p>
        Placement is determined by the active sponsorship for a selected area
        and category and does not guarantee enquiries, bookings, or revenue.
      </p>
      ...
      <ul>
        ...
        <li>
          Their advertising complies with UK law, including consumer protection
      ...
      <h2>7. Liability</h2>
      <p>
        {brandName} accepts no liability for the performance, conduct, pricing,
        availability, or quality of services provided by businesses with
        Sponsored Listings.
      </p>
      ...
      <h2>9. Contact</h2>
      <p>
        If you have questions about Sponsored Listings, advertising, or billing,
