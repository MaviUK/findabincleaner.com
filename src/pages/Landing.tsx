...
const SERVICE_BUTTONS: {
  ...
  { slug: "bin-cleaner", label: "Bin Cleaner", icon: "🗑️", blurb: "Wheelie bins, deep clean & deodorise" },
  { slug: "window-cleaner", label: "Window Cleaner", icon: "🪟", blurb: "Windows, frames, sills" },
  { slug: "cleaner", label: "General Cleaner", icon: "🧼", blurb: "General domestic cleaning" },
];
      ...
      <section className="container mx-auto max-w-5xl px-4 py-10 sm:py-12">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">
            Pick a service, enter your postcode, and contact local businesses.
          </p>
        </div>
